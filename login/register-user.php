        ...
        <div class="login-box">
            <div class="white-box">
                <form data-toggle="validator" class="form-horizontal form-material" id="loginform" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="tel" pattern="[0-9]*" maxlength="11" minlength="10" required id="example-phone" name="mob" class="form-control" placeholder="Enter your mobile number" data-error="Invalid mobile number">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="form-group ">
