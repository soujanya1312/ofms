                ...
                <form data-toggle="validator" method="post">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text" required placeholder="Enter the username" name="cuname">
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <center>
                            <button type="submit" name="cpass" class="btn btn-rounded btn-lg btn-info">Submit</button></center>
                        </div>
                    </form>
                </div>
            </div>
