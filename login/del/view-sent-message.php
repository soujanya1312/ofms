...
$getstaffinfo="SELECT husername FROM events WHERE husername='$staffuname'";
                        ...
                        <div class="white-box">
                            <div class="row">
                                <div class="col-lg-2 col-md-3  col-sm-4 col-xs-12 inbox-panel">
                                    <div> <a href="send-message.php" class="btn btn-custom btn-block waves-effect waves-light">Compose</a>
                                        <div class="list-group mail-list m-t-20">
											...
											<a href="../../admin/sent-messages.php" class="list-group-item">Sent Messages</a> 
										</div>
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <div class="media m-b-30 p-t-20">
                                        ...
                                        <div class="media-body"> <span class="media-meta pull-right"><?php $date=$fetchmsg['timestamp']; echo date('h:i a M d', strtotime($date)); ?></span>
                                            <h4 class="text-danger m-0"><?php echo $fetchstaffinfo['husername']; ?></h4>
                                             </div>
                                    </div>
