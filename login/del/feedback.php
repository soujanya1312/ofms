...
if(isset($_POST['f_email']) || isset($_POST['f_mob']) && isset($_POST['f_msg']))
{
	$fest=mysqli_real_escape_string($connection,$_POST['f_name']);
	$email=mysqli_real_escape_string($connection,$_POST['f_email']);
    $mob=mysqli_real_escape_string($connection,$_POST['f_mob']);
	$feedback=mysqli_real_escape_string($connection,$_POST['f_msg']);
	$insert="INSERT INTO `feedback`(f_name,f_email,f_mob,f_msg) VALUES ('$fest','$email','$mob','$feedback')";
        ...
        <div class="login-box">
            <div class="white-box">
                ...
                <?php }?>
					...
					<div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <a href="../../participants/index.php"><button class="btn btn-danger btn-lg btn-block text-uppercase waves-effect waves-light" >Back</button></a>   
                        </div>
                    </div>
