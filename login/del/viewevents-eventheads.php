	...
	?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="../../eventhead/logout.php" class="btn btn-danger waves-effect waves-light">Proceed for login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                <?php
					$query = "SELECT eid,ename,edesc,erounds,participants FROM events";
                            ...
                            <div class="row">
                               <div class="col-md-4 col-sm-4 text-center">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    ...
                                    <h2 class="box-title m-b-0">
                                   Event Description :<?php echo $result["edesc"]; ?><br>
                                   
                                   Event Contestants :<?php echo $result["participants"]; ?>
                                    </h2>
                                </div>
                            </div>
                        </div>
