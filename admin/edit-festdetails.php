                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <ul class="nav customtab nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="nav-item"><a href="#settings" class="nav-link" aria-controls="settings" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="fa fa-cog"></i></span> <span class="hidden-xs">Edit Fest Details</span></a></li>
...
<!--                            <div class="tab-content">-->
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                <div class="form-group">
                                   <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 mail_listing">
                                    <h3 class="box-title">Fest Rules & Regulations</h3>
									
									<form method="post" data-toggle="validator">
                                        <textarea style="font-weight: normal" required class="textarea_editor form-control" rows="15"  placeholder="Enter text ..." name="frules"></textarea>
                                    </div>
