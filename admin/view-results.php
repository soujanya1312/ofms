            ...
            <div class="container-fluid">
                ...
                <div class="col-md-4 col-sm-4">
                        <div class="white-box">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                   	<img src="../plugins/images/users/result3.jpg" class="img-square img-responsive"> 
                                </div>
                                ...
                                <div class="col-md-8 col-sm-8">
									...
									<div class="p-t-5 align-bottom:10px;">
                                        <a href="view-event-result.php?id=<?php echo $result["eid"]; ?>" class="btn btn-info btn-rounded">view results</a>
                                    </div>
                                </div>
                            </div>
                        </div>
