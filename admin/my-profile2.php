...
$query="SELECT *,event.ename, event.edesc FROM admin INNER JOIN event ON admin.aid=event.aid WHERE ausername='$ausername'";
...
if(isset($_POST['editevent']))
{
	...
	$equery="UPDATE event SET ename='$ename', edate='$edate',edesc='$edesc',cname='$cname',caddress='$caddress',cemail='$cemail',cphone='$phone' WHERE eid='$id'";
	$eresult = mysqli_query($connection, $equery);
	if($eresult)
	{
		$cquery="SELECT ename,edate,edesc,cname,caddress,cemail,cphone FROM event WHERE eid='$id'";
		$cresult = mysqli_query($connection, $cquery);
		$row = mysqli_fetch_assoc($cresult);
		$smsg="Event details updated successfully!";
		$_SESSION['admin']=$row['ename'];
		$ename=$_SESSION['admin'];
    }
	else
	{
		$fmsg="Event details are submitted";
	}
}
                        ...
                        <div class="white-box">
                            ...
                            <div class="tab-pane" id="settings">
                             ...
                             <div class="form-group">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col-md-6" >
                                         <div class="form-group">                                    <label class="control-label">Event Date</label>
                                                    <div class="input-group">
								                         <input onChange="checkDate();" onKeyUp="checkDate();" data-date-format="dd-mm-yyyy" type="text" class="form-control" data-mask="99-99-9999" id="edate" name="edate" placeholder="dd-mm-yyyy">
								                    </div>
								                   <div id="datewarn"></div>
                               ...
                               <div class="form-group">
                                    <label for="Name1" class="control-label">College Name</label>
                                    <div class="form-group col-md-12 p-l-0 p-t-10">
                                    <input type="text" name="cname" ;class="form-control" id="cname" placeholder="Enter the colllege name">
                                     </div>
                                     </div>
                                     <div class="form-group">
                                     <label for="Name2" class="control-label">College Address</label>
                                    <div class="form-group col-md-12 p-l-0 p-t-10">
                                    <input type="text" name="cadd" data-toggle="validator" data-minlength="6" class="form-control" id="cadd1" placeholder="Address panel 1">
                                     </div>
                                    <div class="form-group col-md-12 p-l-0 p-t-10">
                                    <input type="text" name="cadd" data-toggle="validator" data-minlength="6" class="form-control" id="cadd2" placeholder="Address panel 2">
                                     </div>
                                          
                                        <div class="form-group col-md-12 p-l-0 p-t-10">
                                            <label class="control-label"> College Email</label>
                                            <input type="email" name="cemail" id="cemail" class="form-control" placeholder="Enter email address" data-error="email address is invalid">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    <div class="form-group  col-md-12 p-l-0 p-t-10">
                                     <label for="inputphone" class="control-label">College Phone Number</label>
                                     <input type="tel" pattern="[0-9]*" maxlength="11" id="cphone" name="cphone" class="form-control" placeholder="Enter phone no." data-error="Invalid phone number">
								 <div class="help-block with-errors"></div>
                                     </div>
                                     ...
                                     <div class="form-group p-t-0">
                                        ...
                                        <button class="btn btn-success" name="changepw">Change Event Details</button>
