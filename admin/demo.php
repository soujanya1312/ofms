...
$id = $_GET['id'];
$getapointquery="SELECT *,events.ename FROM events INNER JOIN events ON schedule.sc_id = events.eid WHERE sc_id='$id'";
                                                ...
                                                <td>
                                                    <div class="col-sm-6 p-l-0">
												     <div class="input-group">
													     <input type="text" name="ename" class="form-control" id="ename" placeholder="Enter event name" required></td>
                                                    </div>
                                                 </div>
                                                <td>Herman Beck</td>
