	...
	?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                <?php
					$query = "SELECT fid,fname FROM fests";
					$result = mysqli_query($connection, $query);
					foreach($result as $key=>$result)
				{ 
					$eid=$result["fid"];
						
					$getpidquery="SELECT aid from admin WHERE ausername='$ausername'";
					$getpidres=mysqli_query($connection, $getpidquery);
					$row2 = mysqli_fetch_assoc($getpidres);
					$aid= $row2["aid"];

					$redirectquery="SELECT * FROM admin_settings WHERE fname='$eid' and aid='$aid'";
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <h2 class="box-title m-b-0"><?php echo $result["fname"]; ?></h2>
                                  
									<div class="p-t-5">
										
										------------<?php if($redirect>0) { ?>
                                        <a href="add-partcipants.php?id=<?php echo $result["fid"]; ?>" class="btn btn-info btn-rounded">Start Registration</a>
										<?php } else { ?>
										<a href="403.php?id=<?php echo $result["fid"]; ?>" class="btn btn-info btn-rounded">Stop Registration</a>
										<?php } ?>
