...
//    $eventname = $getfestnamero1[ 'ename' ];
    ...
    if ( $result ) {
        ...
        $fmsg = "Team code : $college has already been selected for round $round".mysqli_error($connection);
    }
}
?>
                    ...
                    <div class="white-box">
                        ...
                        <form data-toggle="validator" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" disabled value="<?php echo $ename; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class="form-control" name="erounds">
                                        ...
                                        <option value="<?php echo $countid ?>">
                                            <?php echo 'Round '.$countid; ?>
                                        </option>
                                        <?php $countid++; } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class="form-control" name="teamcode">
                                        ...
                                        <option value="<?php echo $rowcollege['teamcode'];?>">
                                            <?php echo $rowcollege['teamcode'];?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
